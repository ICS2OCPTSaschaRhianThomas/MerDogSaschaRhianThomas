...
function scene:create( event )
    ...
    answerTextObject = display.newText("", display.contentWidth*.4, display.contentHeight*3.4/10, nil, 65 )
    wrongAnswer1TextObject = display.newText("", display.contentWidth*.3, display.contentHeight*3.4/10, nil, 65 )
    wrongAnswer2TextObject = display.newText("", display.contentWidth*.2, display.contentHeight*3.4/10, nil, 65 )
    wrongAnswer3TextObject = display.newText("", display.contentWidth*.1, display.contentHeight*3.4/10, nil, 65 )
